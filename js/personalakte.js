...
export async function renderPersonalakte(container,ctx,employee){
  ...
  const q=query(collection(db,'employeeDocuments'),where('userId','==',employee.id));
