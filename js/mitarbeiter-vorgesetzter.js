...
import { hasSupervisorPermission } from "./permissions.js";
    ...
    (button) =>
      (button.onclick = async () => {
        ...
        try {
          ...
          if(hasSupervisorPermission(ctx.profile,"salaryView")){
            tasks.push(renderSupervisorSalaryHistory(detail.querySelector("#supervisor-salary-history"), employee));
          }
