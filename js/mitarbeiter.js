  ...
  function openEmployeeMasterDataSheet(employee){
    ...
    const sections=[
      ...
      printSection('Urlaub & Arbeitszeit',[
        ['Wochenstunden',employee.weeklyHours],['Urlaubstage / Jahr',employee.vacationDays],['Frühester anrechenbarer Arbeitsbeginn',employee.earliestStartTime?`${employee.earliestStartTime} Uhr`:'–'],['Zeiterfassung auf Projekte',employee.projectTimeTracking===true?'Ja':'Nein'],['Regelmäßige Arbeitstage',selectedWorkDays,true]
      ]),
