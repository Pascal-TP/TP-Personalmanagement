  ...
  function openEmployeeMasterDataSheet(employee){
    ...
    const sections=[
      ...
      printSection('System & Zugang',[
        ['Login',login],['Rolle',ROLE_LABELS[employee.role]||employee.role],['Kontostatus',employee.active===false?'inaktiv':'aktiv'],['Admin-Berechtigungen',permissions,true]
      ])
    ].join('');
